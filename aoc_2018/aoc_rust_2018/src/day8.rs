...
fn get_metadata_sum<'a>(data: &'a[usize], nodes: &mut HashMap<usize, Vec<usize>>,
                        children: &mut DefaultHashMap<usize, Vec<usize>>, mut counter: usize,
                        depth: usize)
